...
function detectLang(){
  ...
  if(['en','zh','fr'].includes(saved)) return saved;
...
function applyLanguage(lang){
  currentLanguage = ['en','zh','fr'].includes(lang) ? lang : 'en';
